...
int main() {
	...
	Base1 *p1 = &d;
    Base2 *p2 = &d;
	cout << "derived pointer value: " << &d << endl;
	cout << "Base0's pointer value: " << p << endl;
	cout << "Base1's pointer value: " << p1 << endl;
	cout << "Base2's pointer value: " << p2 << endl;
	cout << "Base1's var1 pointer: " << &(d.Base1::var1) << endl;
	cout << "Base2's var2 pointer: " << &(d.Base2::var2) << endl;
